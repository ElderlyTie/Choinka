...
int kolory(int numer, int kolor){
    if(numer==5 or numer == 1)
        return floor(kolor*220/255);
    if(numer == 9)
        return floor(kolor*145/255);
    if(numer == 3)
        return floor(kolor*105/255);
    if(numer == 10)
        return floor(kolor*115/255);
    if(numer==4)
        return floor(kolor*80/255);
    if(numer%3==0)
        return floor(kolor*125/255);
    if(numer%3==1)
        return floor(kolor*165/255);
    if(numer%3==2)
        return kolor;
}
